            ...
            <div className="fest-container">
                ...
                <div className="fest-item">
                    <p>
                        <span>
                            For My College </span>
                            Weekend is a celebration of creativity. The joy and liveliness of creating new things from scratch is the point of unification of all the clubs of the Film and Media Council. It is an opportunity for everyone to try their hands on especially tailored events that brings out creativity from within you. In FMC Weekend ’15, there were competitions encompassing the areas of photography, cinematography, animation, entertainment, media and design all of which were based on the theme
                        <span>
                            ‘The Superhero Fiesta’.
                        </span>
                    </p> 
                </div>
                <div className="fest-item">
                    <p>
                        On one hand, events like <span>Selfie, 3-Draw, VFX</span> and the design events tested the participants for their skills in the respective fields whereas on the other hand, events like <span>Superdub, Snapchase</span> and <span>Ad-o-Mania</span> examined their creativity, thinking and ability to work as a team. 
                        Events like <span>RJ Hunt</span> and <span>Brainstorm</span> allowed participants to exhibit their presentation skills and showed the judges how good thinkers they are. 
                        There were also fun events like the <span>Bollywood Quiz</span> and <span>Superhero Quiz</span> in which the so-called ‘old-fashioned’ culture of quizzing was blended with the enjoyment of movies and comics.
                    </p>
                </div>
                <div className="fest-item">
                    <p>
