    ...
    return (
        <>
            <div className="fest-container">
                ...
                <div className="fest-item">
                    <p>For the more technical in you, Technex has Xtreme Engineering and Robotics events.</p>
                    <ul>
                        <li>
                ...
                <div className="fest-item">
                    <ul>
                        <li>Have a novel idea, there is Modex waiting for you. Create whatever you can, a working/non-working model, a simulation or anything that your creative mind can imagine and present in Modex and who knows may be you are the next Steve Jobs who revolutionized the world with a series of ‘I’ products.</li>
                        <li>Technex has much more remaining for the management buffs out there. Have a business idea that can make you next Richard Branson? Share it and if the investors are impressed enough, they may fund you. Assist a real company with a real problem and take away hefty prize money in return. This section is for those whose neurons get activated by case studies, formulating financial models and playing with numbers.</li>
                    </ul>
                </div>
                <div className="fest-subtitle">
                    <span>
                ...
                <div className="fest-item">
                    ...
                    <p>
                        There is a saying: 
                        <span>“We haven’t inherited the world from our fore fathers, rather we have borrowed it from our children’’</span>. 
                        Technex, in accordance with the above, hosts events where your ideas can make this world a more better and sustainable place to live.
                    </p>
                    <p>
