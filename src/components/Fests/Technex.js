  ...
  return (
    <>
      <div className="fest-title-top">
        <h4 className="heading-1">Technex</h4>
        <div className="fest-item-top">
          <p>
            Welcome to one of the biggest techno-management fests of India,
            Technex organized by IIT (BHU), Varanasi. This fest hosts variety of
            events that lay emphasis on both your creative and analytical
          ...
          <div className="fest-sub-item">
            ...
            <div className="fest-item">
              <p>
                ...
                the best of the best. Come to the stage and compete with some of
                the best teams in the world in the field of LAN gaming.
              </p>
              <p>
                There is a saying:
                <span>
            ...
            <div className="fest-item">
              <ul>
                <li>
                  ...
                  whatever you can, a working/non-working model, a simulation or
                  anything that your creative mind can imagine and present in
                  Modex and who knows may be you are the next Steve Jobs who
                  revolutionized the world with a series of ‘I’ products.
                </li>
                <li>
